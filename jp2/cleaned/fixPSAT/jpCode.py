...
def outputMaker(survey,rlist):
    ...
    b2=listToTestTXT(rlist[0],2)
    b3=listToTestTXT(rlist[1],2)
    b1=listToTestTXT(rlist[2],2)
    b4=listToTestTXT(rlist[3],2)
    sout,bDate,tDate=surveyOut(survey)
    fileObj=open('./testDep2/temp{}_{}__{}__{}.txt'.format(firstName,lastName,tDate,bDate),'w')
