...
inputpdf=PdfFileReader(open("{}.pdf".format("12-2-2019"), "rb"))
...
output.addPage(inputpdf.getPage(21))
output.addPage(inputpdf.getPage(22))
output.addPage(inputpdf.getPage(23))
...
with open("./hold/12022019.pdf","wb") as outstream:
